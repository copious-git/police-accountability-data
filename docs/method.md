...
How each figure is computed, including the exact joins, the publishability thresholds and the rounding.

This page is the repository's `METHOD.md`. The column-by-column documentation is under **Column reference**.
